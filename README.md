...
Ideas for new features include a password to access the journal, updating the GUI to look more modern, and potentially adding a quote of the day on the bottom of the calendar, which would shuffle between a dictionary of quotes. 